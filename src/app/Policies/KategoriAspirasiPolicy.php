...
class KategoriAspirasiPolicy
{
    ...
    {
        return $user->can('view_any_kategori::aspirasi');
    }
    ...
    {
        return $user->can('view_kategori::aspirasi');
    }
    ...
    {
        return $user->can('create_kategori::aspirasi');
    }
    ...
    {
        return $user->can('update_kategori::aspirasi');
    }
    ...
    {
        return $user->can('delete_kategori::aspirasi');
    }
    ...
    {
        return $user->can('delete_any_kategori::aspirasi');
    }
     ...
     */
    public function replicate(User $user, KategoriAspirasi $kategoriAspirasi): bool
    {
